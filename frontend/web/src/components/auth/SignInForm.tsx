...
export default function SignInForm() {
  ...
  const [email, setEmail] = useState("");        // dùng như username
  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await api.post("/auth/staff/login", {
        // map đúng key backend đang nhận
        NV_TAIKHOAN: email,
        NV_MATKHAU: password,
      });
            ...
            <form onSubmit={onSubmit}>
              <div className="space-y-6">
                <div>
                  ...
                  <Input placeholder="info@gmail.com" type="text" name={email}  onChange={(e) => setEmail(e.target.value)}/>
                </div>
                <div>
                  <Label>
